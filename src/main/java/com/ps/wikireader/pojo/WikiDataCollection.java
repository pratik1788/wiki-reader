...
public class WikiDataCollection extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static WikiDataCollection fromByteBuffer(
   ...
   private java.util.List<com.ps.wikireader.pojo.WikiData> wikiDataList;
   ...
   */
  public WikiDataCollection(java.util.List<com.ps.wikireader.pojo.WikiData> wikiDataList) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: wikiDataList = (java.util.List<com.ps.wikireader.pojo.WikiData>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<com.ps.wikireader.pojo.WikiData> getWikiDataList() {
    return wikiDataList;
  }
   ...
   */
  public void setWikiDataList(java.util.List<com.ps.wikireader.pojo.WikiData> value) {
   ...
   */
  public static com.ps.wikireader.pojo.WikiDataCollection.Builder newBuilder() {
    return new com.ps.wikireader.pojo.WikiDataCollection.Builder();
  }
   ...
   * @return A new WikiDataCollection RecordBuilder
   */
  public static com.ps.wikireader.pojo.WikiDataCollection.Builder newBuilder(com.ps.wikireader.pojo.WikiDataCollection.Builder other) {
    if (other == null) {
      return new com.ps.wikireader.pojo.WikiDataCollection.Builder();
    } else {
      return new com.ps.wikireader.pojo.WikiDataCollection.Builder(other);
    }
  }
   ...
   * @return A new WikiDataCollection RecordBuilder
   */
  public static com.ps.wikireader.pojo.WikiDataCollection.Builder newBuilder(com.ps.wikireader.pojo.WikiDataCollection other) {
    if (other == null) {
      return new com.ps.wikireader.pojo.WikiDataCollection.Builder();
    } else {
      return new com.ps.wikireader.pojo.WikiDataCollection.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WikiDataCollection>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ps.wikireader.pojo.WikiDataCollection.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ps.wikireader.pojo.WikiDataCollection other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.wikiDataList)) {
        this.wikiDataList = data().deepCopy(fields()[0].schema(), other.wikiDataList);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikireader.pojo.WikiDataCollection.Builder setWikiDataList(java.util.List<com.ps.wikireader.pojo.WikiData> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikireader.pojo.WikiDataCollection.Builder clearWikiDataList() {
      wikiDataList = null;
    ...
    public WikiDataCollection build() {
      try {
        ...
        record.wikiDataList = fieldSetFlags()[0] ? this.wikiDataList : (java.util.List<com.ps.wikireader.pojo.WikiData>) defaultValue(fields()[0]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (com.ps.wikireader.pojo.WikiData e0: this.wikiDataList) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<com.ps.wikireader.pojo.WikiData> a0 = this.wikiDataList;
      if (a0 == null) {
        a0 = new SpecificData.Array<com.ps.wikireader.pojo.WikiData>((int)size0, SCHEMA$.getField("wikiDataList").schema());
        this.wikiDataList = a0;
      } else a0.clear();
      SpecificData.Array<com.ps.wikireader.pojo.WikiData> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<com.ps.wikireader.pojo.WikiData>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          com.ps.wikireader.pojo.WikiData e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new com.ps.wikireader.pojo.WikiData();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
