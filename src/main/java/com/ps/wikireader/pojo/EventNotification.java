...
public class EventNotification extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6270366884424358835L;
...
static {
   ...
   */
  public static com.ps.wikireader.pojo.EventNotification.Builder newBuilder() {
    return new com.ps.wikireader.pojo.EventNotification.Builder();
  }
   ...
   * @return A new EventNotification RecordBuilder
   */
  public static com.ps.wikireader.pojo.EventNotification.Builder newBuilder(com.ps.wikireader.pojo.EventNotification.Builder other) {
    if (other == null) {
      return new com.ps.wikireader.pojo.EventNotification.Builder();
    } else {
      return new com.ps.wikireader.pojo.EventNotification.Builder(other);
    }
  }
   ...
   * @return A new EventNotification RecordBuilder
   */
  public static com.ps.wikireader.pojo.EventNotification.Builder newBuilder(com.ps.wikireader.pojo.EventNotification other) {
    if (other == null) {
      return new com.ps.wikireader.pojo.EventNotification.Builder();
    } else {
      return new com.ps.wikireader.pojo.EventNotification.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventNotification>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ps.wikireader.pojo.EventNotification.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ps.wikireader.pojo.EventNotification other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.fileName)) {
        this.fileName = data().deepCopy(fields()[0].schema(), other.fileName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikireader.pojo.EventNotification.Builder setFileName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikireader.pojo.EventNotification.Builder clearFileName() {
      fileName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikireader.pojo.EventNotification.Builder setEventName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikireader.pojo.EventNotification.Builder clearEventName() {
      eventName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikireader.pojo.EventNotification.Builder setEventTimeStamp(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ps.wikireader.pojo.EventNotification.Builder clearEventTimeStamp() {
